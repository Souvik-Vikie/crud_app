...
import { insertUsers } from '../API/users';
import '../index.css';
...
const CreateUser = () => {
    ...
    const [details, setDetails] = useState(initialUserData);
                ...
                <div className="w-full px-6 py-4 mt-6 overflow-hidden bg-white shadow-md sm:max-w-lg sm:rounded-lg">
                    <form onSubmit={(e) => handleSubmit(e)}>
                        <div>
                          ...
                          {showError?<div style={{ color: "red" }}>{errors.firstName}</div>:""}
                        </div>
                        <div className="mt-4">
                            <label
                                htmlFor="lastName"
                           ...
                           {showError ? <div style={{ color: "red" }}>{errors.lastName}</div>:""}
                        </div>
                        <div className="mt-4">
                            <label
                                htmlFor="phoneNumber"
                           ...
                           {showError?<div style={{ color: "red" }}>{errors.phoneNumber}</div>:""}
                        ...
                        <div className="mt-4">
                           ...
                           {showError ? <div style={{ color: "red" }}>{errors.age}</div>:""}
